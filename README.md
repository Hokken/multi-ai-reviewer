...
Those artifacts can be generated by any LLM that can use the repo-local skills:

- **`investigate`** — produces structured investigation reports in `docs/investigations/` (`.claude/skills/investigate/SKILL.md` or `.agents/skills/investigate/SKILL.md`)
- **`plan`** — produces implementation plan artifacts in `docs/plans/` (`.claude/skills/plan/SKILL.md` or `.agents/skills/plan/SKILL.md`)
- **`review-instructions`** — produces implementation review artifacts for later `mrev review implementation` passes (`.claude/skills/review-instructions/SKILL.md` or `.agents/skills/review-instructions/SKILL.md`)
