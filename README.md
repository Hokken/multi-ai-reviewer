...
Those artifacts can be generated by any LLM that can use the repo-local `review-instructions` skill from either `.claude/skills/review-instructions/SKILL.md` or `.agents/skills/review-instructions/SKILL.md`.

That skill is the glue between authoring work and `mrev review`:
