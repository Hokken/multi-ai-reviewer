...
- **`review-instructions`** — produces plan and implementation review artifacts (`.claude/skills/review-instructions/SKILL.md` or `.agents/skills/review-instructions/SKILL.md`)
